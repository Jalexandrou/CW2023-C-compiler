...
%token T_DIVIDE T_PLUS T_MINUS T_EXPONENT T_INC T_DEC T_MOD T_POW
...
%type <expr> LOGICAL_OR_EXPRESSION CONDITIONAL_EXPRESSION ASSIGNMENT_EXPRESSION ASSIGNMENT_OPERATOR EXPRESSION
...
%type <expr> ENUMERATOR_LIST ENUMERATOR TYPE_QUALIFIER DECLARATOR DIRECT_DECLARATOR POINTER TYPE_QUALIFIER_LIST PARAMETER_TYPE_LIST
...
%type <expr> FUNCTION_DEFINITION SPECIFIER_QUALIFIER_LIST STRUCT_DECLARATOR 
...
POSTFIX_EXPRESSION
	...
	| POSTFIX_EXPRESSION T_STAR T_IDENTIFIER
...
SHIFT_EXPRESSION
	...
	| SHIFT_EXPRESSION T_LEFTSHIFT ADDITIVE_EXPRESSION
	| SHIFT_EXPRESSION T_RIGHTSHIFT ADDITIVE_EXPRESSION
	;

RELATIONAL_EXPRESSION
	: SHIFT_EXPRESSION									{ $$ = $1; }
	| RELATIONAL_EXPRESSION T_LESS SHIFT_EXPRESSION
	| RELATIONAL_EXPRESSION T_GREATER SHIFT_EXPRESSION
	| RELATIONAL_EXPRESSION T_LESS SHIFT_EXPRESSION
	| RELATIONAL_EXPRESSION T_GREATER SHIFT_EXPRESSION
	;
...
AND_EXPRESSION
	...
	| AND_EXPRESSION T_BAND EQUALITY_EXPRESSION
	;
...
INCLUSIVE_OR_EXPRESSION
	...
	| INCLUSIVE_OR_EXPRESSION T_BOR EXCLUSIVE_OR_EXPRESSION
	;
...
JUMP_STATEMENT
	...
	| T_RETURN EXPRESSION T_SEMICOLON 		  	{ $$ = new Statement($2); }
	;
