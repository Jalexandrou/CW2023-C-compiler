...
LABELED_STATEMENT
	...
	| T_CASE CONSTANT_EXPRESSION T_COLON STATEMENT							{ $$ = new Case_Node($2, $4); }
	| T_DEFAULT T_COLON STATEMENT
	;

COMPOUND_STATEMENT
	: T_LCURBRACKET T_RCURBRACKET											{ $$ = new Empty_Compound_Statement(); }
...
SELECTION_STATEMENT
	...
	| T_SWITCH T_LBRACKET EXPRESSION T_RBRACKET STATEMENT					{ $$ = new Switch_Node($3, $5); }//Switch Node
	;
...
ITERATION_STATEMENT
	...
	| T_FOR T_LBRACKET EXPRESSION_STATEMENT EXPRESSION_STATEMENT T_RBRACKET STATEMENT	{ $$ = new For_Node($3, $4, NULL, $6); }
	| T_FOR T_LBRACKET EXPRESSION_STATEMENT EXPRESSION_STATEMENT EXPRESSION T_RBRACKET STATEMENT { $$ = new For_Node($3, $4, $5, $7); }
	;
...
TRANSLATION_UNIT
	...
	| TRANSLATION_UNIT EXTERNAL_DECLARATION									{ g_root = new Translation_Unit($1, $2); }
	;
